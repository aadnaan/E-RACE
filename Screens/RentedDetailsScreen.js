        ...
        <View style={{marginTop:17,flex:1}}>
            <Cards style={{margin:10,padding:10}}>
                <View style={{flexDirection:'row',justifyContent:"space-between"}}>
                    <View style={{}}>
                        <Text style={{fontSize:14,fontWeight:'500',color:'#800080'}}>Rented to : <Text style={{fontSize:16,fontWeight:'500',color:'black'}}>Ali</Text></Text>
                        ...
                        <Text style={{fontSize:14,fontWeight:'500',color:'#800080'}}>Registration: <Text style={{fontSize:14,fontWeight:'500',color:'black'}}>ASD-567</Text></Text>
                        <Text style={{fontSize:14,fontWeight:'500',color:'#800080'}}>Renter's License no: <Text style={{fontSize:14,fontWeight:'500',color:'black'}}>42101-7691475-7</Text></Text>
